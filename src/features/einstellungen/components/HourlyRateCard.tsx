...
/** Feeds Kunden's "new client" form via `get_default_hourly_rate()` — the only field of this whole admin-only table an employee reaches (docs/DATABASE_SCHEMA.md §7). */

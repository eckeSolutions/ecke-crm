...
export function InvoiceListScreen() {
  ...
  // Row click -> open, same composedPath() pattern the clients and
  // time-tracking features' tables use (ecke-table emits no row event of its own).
  useEffect(() => {
    ...
    const onClick = (event: MouseEvent) => {
      ...
      if (invoice) navigate(`/invoices/${invoice.id}`, { viewTransition: true });
    };

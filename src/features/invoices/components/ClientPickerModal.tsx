 ...
 * repo's clients dataset (dozens of clients) makes a scrolling button list
 * the wrong shape for the same picker that already works fine as a
 * dropdown in the time-tracking feature's modals.
 */
          ...
          render={({ field }) => (
            <EckeField label="Kunde *" error={errors.client_id?.message}>
              <EckeDropdown
                ...
                // the time-tracking feature's structurally identical StartTimerModal
